# zk-llm CLI Implementation Plan

> **For agentic workers:** REQUIRED SUB-SKILL: Use superpowers:subagent-driven-development (recommended) or superpowers:executing-plans to implement this plan task-by-task. Steps use checkbox (`- [ ]`) syntax for tracking.

**Goal:** Ship a Swift SwiftPM executable `zk-llm` that exposes a Zettelkasten archive to coding agents via `search`, `tag`, and `show` subcommands, with YAML output and bounded wiki-link graph expansion.
...
- Create: `Sources/zk-llm/main.swift`
- Create: `Tests/zk-llmTests/SmokeTests.swift`
- Create: `.gitignore`
...
Expected: exit 0, produces `.build/debug/zk-llm`.
...
**Files:**
- Create: `Sources/zk-llm/Model/NoteRef.swift`
- Create: `Tests/zk-llmTests/Model/NoteRefTests.swift`
...
```bash
git add Sources/zk-llm/Model/ Tests/zk-llmTests/Model/
...
**Files:**
- Create: `Tests/zk-llmTests/Fixtures/sample-archive/202503091430 Mental Models.md`
- Create: `Tests/zk-llmTests/Fixtures/sample-archive/202503091431 Second Order Thinking.md`
- Create: `Tests/zk-llmTests/Fixtures/sample-archive/202503091432 Inversion.md`
- Create: `Tests/zk-llmTests/Fixtures/sample-archive/202503091433 Compounding.md`
- Create: `Tests/zk-llmTests/Fixtures/sample-archive/202503091434 Feedback Loops.md`
- Create: `Tests/zk-llmTests/Fixtures/sample-archive/202503091435 Base Rates.md`
- Create: `Tests/zk-llmTests/Fixtures/sample-archive/202503091436 Coding Note.md`
- Create: `Tests/zk-llmTests/Fixtures/sample-archive/202503091437 Url Note.md`
- Create: `Tests/zk-llmTests/Fixtures/sample-archive/202503091438 Unicode Tag.md`
- Create: `Tests/zk-llmTests/Fixtures/sample-archive/202503091439 Ambiguous Prefix A.md`
- Create: `Tests/zk-llmTests/Fixtures/sample-archive/202503091440 Ambiguous Prefix B.md`
- Create: `Tests/zk-llmTests/Fixtures/sample-archive/202503091441 Unresolved Link.md`
- Create: `Tests/zk-llmTests/Fixtures/sample-archive/Unknown Id Note.md`
...
```bash
git add Tests/zk-llmTests/Fixtures/
...
**Files:**
- Create: `Sources/zk-llm/Parsing/HashtagRegex.swift`
- Create: `Tests/zk-llmTests/Parsing/HashtagRegexTests.swift`
...
```bash
git add Sources/zk-llm/Parsing/ Tests/zk-llmTests/Parsing/
...
**Files:**
- Create: `Sources/zk-llm/Parsing/WikiLinkRegex.swift`
- Create: `Tests/zk-llmTests/Parsing/WikiLinkRegexTests.swift`
...
```swift
// Tests/zk-llmTests/Parsing/WikiLinkRegexTests.swift
import Testing
@testable import zk_llm
...
```swift
// Sources/zk-llm/Parsing/WikiLinkRegex.swift
import Foundation
...
```bash
git add Sources/zk-llm/Parsing/WikiLinkRegex.swift Tests/zk-llmTests/Parsing/WikiLinkRegexTests.swift
...
**Files:**
- Create: `Sources/zk-llm/Parsing/NonCodeTextExtractor.swift`
- Create: `Tests/zk-llmTests/Parsing/NonCodeTextExtractorTests.swift`
...
```swift
// Tests/zk-llmTests/Parsing/NonCodeTextExtractorTests.swift
import Testing
import Markdown
@testable import zk_llm
...
```swift
// Sources/zk-llm/Parsing/NonCodeTextExtractor.swift
import Foundation
import Markdown
...
```bash
git add Sources/zk-llm/Parsing/NonCodeTextExtractor.swift Tests/zk-llmTests/Parsing/NonCodeTextExtractorTests.swift
...
**Files:**
- Create: `Sources/zk-llm/Pipeline/NoteIndex.swift`
- Create: `Tests/zk-llmTests/Pipeline/NoteIndexTests.swift`
...
```bash
git add Sources/zk-llm/Pipeline/NoteIndex.swift Tests/zk-llmTests/Pipeline/NoteIndexTests.swift
...
**Files:**
- Create: `Sources/zk-llm/Model/ParsedNote.swift`
- Create: `Sources/zk-llm/Parsing/NoteParser.swift`
- Create: `Tests/zk-llmTests/Parsing/NoteParserTests.swift`
...
```bash
git add Sources/zk-llm/Model/ParsedNote.swift Sources/zk-llm/Parsing/NoteParser.swift Tests/zk-llmTests/Parsing/NoteParserTests.swift
...
**Files:**
- Create: `Sources/zk-llm/Config/ArchiveResolver.swift`
- Create: `Tests/zk-llmTests/Config/ArchiveResolverTests.swift`
...
```bash
git add Sources/zk-llm/Config/ Tests/zk-llmTests/Config/
...
**Files:**
- Create: `Sources/zk-llm/Pipeline/RipgrepRunner.swift`
- Create: `Tests/zk-llmTests/Pipeline/RipgrepRunnerTests.swift`
...
```bash
git add Sources/zk-llm/Pipeline/RipgrepRunner.swift Tests/zk-llmTests/Pipeline/RipgrepRunnerTests.swift
...
**Files:**
- Create: `Sources/zk-llm/Model/SearchHit.swift`
- Create: `Sources/zk-llm/Pipeline/StructuralFilter.swift`
- Create: `Tests/zk-llmTests/Pipeline/StructuralFilterTests.swift`
...
```bash
git add Sources/zk-llm/Model/SearchHit.swift Sources/zk-llm/Pipeline/StructuralFilter.swift Tests/zk-llmTests/Pipeline/StructuralFilterTests.swift
...
**Files:**
- Create: `Sources/zk-llm/Pipeline/GraphExpander.swift`
- Create: `Tests/zk-llmTests/Pipeline/GraphExpanderTests.swift`
...
```bash
git add Sources/zk-llm/Pipeline/GraphExpander.swift Tests/zk-llmTests/Pipeline/GraphExpanderTests.swift
...
**Files:**
- Create: `Sources/zk-llm/Output/SearchYAMLEmitter.swift`
- Create: `Tests/zk-llmTests/Output/SearchYAMLEmitterTests.swift`
...
```swift
// Tests/zk-llmTests/Output/SearchYAMLEmitterTests.swift
import Testing
@testable import zk_llm
...
```swift
// Sources/zk-llm/Output/SearchYAMLEmitter.swift
import Foundation
...
```bash
git add Sources/zk-llm/Output/SearchYAMLEmitter.swift Tests/zk-llmTests/Output/SearchYAMLEmitterTests.swift
...
**Files:**
- Create: `Sources/zk-llm/Output/ShowEmitter.swift`
- Create: `Tests/zk-llmTests/Output/ShowEmitterTests.swift`
...
```bash
git add Sources/zk-llm/Output/ShowEmitter.swift Tests/zk-llmTests/Output/ShowEmitterTests.swift
...
**Files:**
- Create: `Sources/zk-llm/Commands/SearchCommand.swift`
- Modify: `Sources/zk-llm/main.swift` (register subcommand)
- Create: `Tests/zk-llmTests/Commands/SearchCommandTests.swift`
...
```swift
// Tests/zk-llmTests/Commands/SearchCommandTests.swift
import Testing
import Foundation
@testable import zk_llm
...
```swift
// Sources/zk-llm/Commands/SearchCommand.swift
import Foundation
import ArgumentParser
...
```bash
swift build -c debug
./.build/debug/zk-llm search --archive Tests/zk-llmTests/Fixtures/sample-archive --tag learning --depth 1
```
...
```bash
git add Sources/zk-llm/Commands/SearchCommand.swift Sources/zk-llm/main.swift Tests/zk-llmTests/Commands/SearchCommandTests.swift
...
**Files:**
- Create: `Sources/zk-llm/Commands/TagCommand.swift`
- Modify: `Sources/zk-llm/main.swift` (register subcommand)
- Create: `Tests/zk-llmTests/Commands/TagCommandTests.swift`

Context: spec §3. `zk-llm tag TAGNAME [--depth N]` is equivalent to `zk-llm search --tag TAGNAME [--depth N]`.

- [ ] **Step 1: Write failing test**

```swift
// Tests/zk-llmTests/Commands/TagCommandTests.swift
import Testing
import Foundation
@testable import zk_llm
...
```swift
// Sources/zk-llm/Commands/TagCommand.swift
import Foundation
import ArgumentParser
...
```bash
swift build -c debug
./.build/debug/zk-llm tag thinking --archive Tests/zk-llmTests/Fixtures/sample-archive
```
...
```bash
git add Sources/zk-llm/Commands/TagCommand.swift Sources/zk-llm/main.swift Tests/zk-llmTests/Commands/TagCommandTests.swift
...
**Files:**
- Create: `Sources/zk-llm/Commands/ShowCommand.swift`
- Modify: `Sources/zk-llm/main.swift`
- Create: `Tests/zk-llmTests/Commands/ShowCommandTests.swift`

Context: spec §3. `zk-llm show REF...`. Exit 0 if any ref resolved, non-zero if none did.
...
```bash
swift build -c debug
./.build/debug/zk-llm show --archive Tests/zk-llmTests/Fixtures/sample-archive "202503091430 Mental Models.md"
```
...
```bash
git add Sources/zk-llm/Commands/ShowCommand.swift Sources/zk-llm/main.swift Tests/zk-llmTests/Commands/ShowCommandTests.swift
...
**Files:**
- Create: `Tests/zk-llmTests/IntegrationTests.swift`
...
```swift
// Tests/zk-llmTests/IntegrationTests.swift
import Testing
import Foundation
@testable import zk_llm
...
```bash
git add Tests/zk-llmTests/IntegrationTests.swift
...
- [ ] Every spec section in `docs/superpowers/specs/2026-04-17-zk-llm-cli-design.md` is covered by a task. (Tasks 1–19 collectively cover commands, pipeline, data model, output, config, stack, layout, testing, and the deliverable; out-of-scope items remain out of scope.)
- [ ] Every ADR is reflected in implementation: ADR-001 (Task 5), ADR-002 (Task 4), ADR-003 (Task 15), ADR-004 (Task 13), ADR-005 (Task 14).
- [ ] `swift test` is green.
- [ ] `./.build/release/zk-llm search --tag foo --depth 3` completes in under 2 seconds on the user's real 10K-note archive.
